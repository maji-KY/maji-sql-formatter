...
export default class Formatter {
  ...
  /**
     ...
     *   @param {Object} cfg.indent indent
     *   @param {Object} cfg.params params
     * @param {Tokenizer} tokenizer tokenizer
     */
  constructor(
    readonly cfg: FormatConfig = {},
    readonly tokenizer,
    readonly indentation = new Indentation(cfg.indent),
    readonly params = new Params(cfg.params),
  ) {
  }
  ...
  getFormattedQueryFromTokens() {
    ...
    this.tokens.forEach((token: any, index) => {
      this.index = index;
