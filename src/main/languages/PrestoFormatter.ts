...
export default class PrestoFormatter {
  /**
     * @param {Object} cfg Different set of configurations
     */
  constructor(readonly cfg) {
  }

  /**
     * Format the whitespace in a Presto string to make it easier to read
     *
     * @param {String} query The Presto string
